...
document.getElementById('login-form').addEventListener('submit', async function (event) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            drawLineplotGraph(exerciseXPs, ".lineplot-graph-exercises", "Cumulative sum of XPs earned from exercises")

            // line plot for projects XPs
            const projectXPs = userXPs.filter(item => item.object.type === 'project');
            drawLineplotGraph(projectXPs, ".lineplot-graph-projects", "Cumulative sum of XPs earned from projects")
...
function setUserInfo(userInfoData, userProjectXPs, jsPiscine, auditsUserDid, auditsOthersDidToUser) {
    console.log(" userInfoData.attrs", userInfoData.attrs);
...
// DRAW GRAPHS
// lineplot
function drawLineplotGraph(rawData, element, title) {
    ...
    svg.append("g")
        ...
        .call(xAxis)
        .selectAll("path, line")       // Select the path and the line of the x-axis
        .style("stroke", "rgb(255, 127, 14)")        // Here, I'm setting the color to red; change as needed

    // Change the color of the x-axis text (tick labels)
    svg.selectAll("g.x-axis text")    // Add a class to the x-axis (like "x-axis") if you want to use this selector
    ...
    svg.append("g")
        ...
        // Change the color of the y-axis text (tick labels)
    svg.selectAll("g.y-axis text")    // Add a class to the y-axis (like "y-axis") if you want to use this selector
        .style("fill", "rgb(255, 127, 14)");
